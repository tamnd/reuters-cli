...
Most of these come down to network reality or how reuters-cli serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

reuters-cli rate-limits like any public site. reuters already paces
...
Where a surface is gated, reuters reads a cookie or token you supply
...
`reuters`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what reuters actually did
